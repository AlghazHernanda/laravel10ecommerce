                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{ route('product.details',['slug'=>$rel_product->slug]) }}" tabindex="0">
                                                            <img src="{{ asset('assets/imgs/shop/product-')}}{{ $rel_product->id }}-1.jpg" alt="{{ $rel_product->name }}">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{ route('product.details',['slug'=>$rel_product->slug]) }}" tabindex="0">{{ $rel_product->name }}</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                                    <div class="product-price">
                                                        <span>{{ $rel_product->regular_price }} </span>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{ asset('assets/imgs/shop/product-')}}{{ $new_product->id }}-1.jpg" alt="{{ $new_product->name }}">
                                </div>
